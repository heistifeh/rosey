...
export function GeneralInformationForm() {
  ...
  const progressSteps = [
    { number: 1, label: "General Information", isActive: true },
    { number: 2, label: "Profile Setup", isActive: false },
  ...
  return (
    <div className="flex flex-col flex-1 w-full px-4 md:px-0 overflow-y-auto">
      <div className="w-full max-w-7xl mx-auto flex flex-col gap-6 md:gap-8 py-6 items-center justify-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-start">
              <div className="flex flex-col gap-6 sm:gap-10">
                ...
                <div className="flex flex-col gap-2 min-h-[120px]">
                  ...
                  <p className="text-[12px] font-normal text-text-gray-opacity">
                    This affects your URL as well as the description when
                    linking on socials.
                  </p>
                </div>
                ...
                <div className="flex flex-col gap-2 min-h-[148px]">
                  ...
                  <p className="text-[12px] font-normal text-text-gray-opacity">
                    For transgender individuals who wish to disclose, this is
                    the space to do it. Contact us if you'd like to recommend
                    more categories.
                  </p>
                </div>
                ...
                <div className="flex flex-col gap-2 min-h-[148px]">
                  ...
                  <p className="text-[12px] font-normal text-text-gray-opacity">
                    Specify the categories of clients you cater to (Male,
                    Female, Couples, Non-Binary). Select all four if you cater
                    for all.
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-6 sm:gap-10">
                ...
                <div className="flex flex-col gap-2 min-h-[148px]">
                  ...
                  <p className="text-[12px] font-normal text-text-gray-opacity">
                    Restrict your profile so it appears only when users apply
                    the trans-only search filter.
                  </p>
                </div>
                ...
                <div className="flex flex-col gap-2 min-h-[92px]">
                  ...
                  <Select
                    ...
                    onValueChange={(value) =>
                      handleChange("displayedAge", value)
                    }
                  >
                    <SelectTrigger>
                      <SelectValue />
                ...
                <div className="flex flex-col gap-2 min-h-[148px]">
                  ...
                  <p className="text-[12px] font-normal text-text-gray-opacity">
                    If your account is inactive for a set time, your profile
                    will be hidden automatically. You can make it visible again
                    by logging into your dashboard and republishing.
                  </p>
                </div>
                ...
                <div className="flex flex-col gap-2 min-h-[148px]">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      handleChange("homeLocations", e.target.value)
                    }
                  />
                  <p className="text-[12px] font-normal text-text-gray-opacity">
                    If your account is inactive for a set time, your profile
